...
int portarossa = 12; // porta 11 da collegare all’anodo “rosso” del modulo RGB
int portaverde = 13; // porta 10 da collegare all’anodo “verde” del modulo RGB
int portablu = 0; // porta 9 da collegare all’anodo “blu” del modulo RBG
